<?php
    ...
    class Utility {
        ...
        public function loadCustomerDropDown()
        {
            ...
            $html .= "<ul class=\"dropdown-menu\" aria-labelledby=\"navbarDropdownCustomerNotLoginned\">";
            $html .= "<li><a class=\"dropdown-item\" href=\"/customerLogin\">Login</a></li>";
            $html .= "<li><a class=\"dropdown-item\" href=\"/customerRegister\">Register</a></li>";
            $html .= "</ul>";
            return $html;
        }
    }